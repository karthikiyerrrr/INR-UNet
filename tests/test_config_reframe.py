...
from inr_unet.data.dataset import build_label_field
...
def test_build_label_field_gaussian_uses_config():
    ...
    field = build_label_field(cfg.data.synthetic)
...
def test_build_label_field_circular():
    ...
    assert isinstance(build_label_field(cfg.data.synthetic), CircularField)
